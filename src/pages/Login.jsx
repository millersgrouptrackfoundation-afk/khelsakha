    ...
    <div className="min-h-screen bg-[#F9F7F3] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <img src="/logo.png" alt="KhelSakha" className="w-16 h-16 object-contain mx-auto mb-4" />
          <h1 className="text-3xl font-bold text-[#1A3B2E]" style={{fontFamily:"Playfair Display,serif"}}>KhelSakha</h1>
          <p className="text-gray-500 text-sm mt-1">School Sports OS · by MGTF</p>
          <p className="text-xs text-gray-400 mt-1 italic">Khelo. Seekho. Badho.</p>
        </div>

        <div className="bg-white rounded-2xl shadow-sm p-6">
          <h2 className="text-lg font-semibold text-[#1A3B2E] mb-5">Sign in to your account</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#E76F51] text-white rounded-xl font-semibold hover:bg-[#d65f41] transition-colors disabled:opacity-50 text-sm"
            >
